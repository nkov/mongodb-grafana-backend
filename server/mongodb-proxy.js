...
app.all('/', function(req, res, next)
{
  logRequest(req.body, "/")
  setCORSHeaders(res);
  const client = new MongoClient(req.body.db.url, { useNewUrlParser: true, useUnifiedTopology: true });
...
{
  const client = new MongoClient(body.db.url, { useNewUrlParser: true, useUnifiedTopology: true });
  client.connect(function (err)
  {
    if ( err != null )
    {
